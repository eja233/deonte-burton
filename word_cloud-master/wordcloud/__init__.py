...
def fit_words(words, font_path=None, width=800, height=800,
...
def draw(elements, file_name, font_path=None, width=800, height=800, scale=1,
...
def process_text(text, max_features=75, stopwords=None):
